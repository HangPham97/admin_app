                                            ...
                                            <div class="item {!! $count == 0 ? 'active' : '' !!}">
                                                ...
                                                <div class="top-post-details">
                                                    ...
                                                    <ul class="meta">
                                                        ...
                                                        <li><a href="#"><span
                                                                        class="lnr lnr-calendar-full"></span>{{$item->created_at}}
                                                            </a></li>
                                    ...
                                    @foreach($travel_newses as $news)
                                        @if($loop->index == 0)
                                            <div class="feature-img-wrap relative">
                                                <div class="feature-img relative">
                                                    <div class="overlay overlay-bg"></div>
                                                    <img class="img-fluid" src="{{$travel_newses[0]->cover_origin}}"
                                                         alt="">
                                                </div>
                                                <ul class="tags">
                                            ...
                                            <div class="details">
                                                ...
                                                <ul class="meta">
                                                    ...
                                                    <li><a href="#"><span
                                                                    class="lnr lnr-calendar-full"></span>{{$travel_newses[0]->created_at}}
                                                        </a></li>
                                                    <li><a href="#"><span class="lnr lnr-bubble"></span>06 </a></li>
                                                </ul>
                                                <p class="excert">
                                                ...
                                                <div class="post-lists">
                                                    <div class="single-post d-flex flex-row">
                                                        ...
                                                        <div class="detail">
                                                            ...
                                                            <ul class="meta">
                                                                <li><a href="#"><span
                                                                                class="lnr lnr-calendar-full"></span>{{$news->created_at}}
                                                                    </a></li>
                                                                <li><a href="#"><span
